...
<div class="span12">
    <section id="global">
        <form method="post">
            ...
            <div class="row-fluid" id="region_container">
                <div class="span2">Region</span></div>
                <div class="span10">
    ...
    $.extend({
        ...
        extractData : function(){
            ...
            if (errors.length > 0) {
                ...
                $.post('../market_data/data_extraction_mp_generate_link',$('form').serialize(),
        ...
        ,exportReport:function(){
            $.download('../market_data/file_data_extraction_mp',$('form').serialize());
        }
...
<script>
    ...
    $('#export_mp_csv').live('click',function(){
        $.exportReport();
    })
