    ...
    $.extend({
        ...
        extractData : function(){
            ...
            if (errors.length > 0) {
                ...
                $.post('../market_data/data_extraction_ps_generate_link',$('form').serialize(),
        ...
        ,exportReport:function(){
            $.download('../market_data/file_data_extraction_ps',$('form').serialize());
        }
...
<script>
    ...
    $('#export_ps_csv').live('click',function(){
        $.exportReport();
    })
</script>
