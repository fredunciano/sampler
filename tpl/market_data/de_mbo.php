...
$.extend({
    ...
    extractData : function(){
        ...
        if (errors.length > 0) {
            ...
            $("#result").html('Please wait, checking data &nbsp;&nbsp;&nbsp;<img src="../images/ajax-loader.gif">');
            $.post('../market_data/data_extraction_generate_link',$('form').serialize(),
    ...
    ,exportReport:function(){
        $.download('../market_data/file_data_extraction_mbo',$('form').serialize());
    }
