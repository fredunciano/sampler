...
<div class="span12">
    ...
    <div class="row-fluid">
        ...
        <div class="span10 input-append">
            <input type="text" id="datepicker" class="span2">
...
$.extend({
    list : function(){
        ...
        $('#result').html('<legend><h6>Delivery Date : '+ $('#datepicker').val()+'</h6></legend>'+
        ...
        $.post('../trading_plant/dap_plant_cap_load',{resource_id:$('#resource').val(),date:$('#datepicker').val(),type:'DAP'},
        function(data){
            data = $.parseJSON(data);
